...
const kz: Partial<Record<Keys, string>> = {
  ...
  proCtaTitle: "Pro-ға өтіңіз — толық мүмкіндіктерді ашыңыз",
  proCtaSubtitle: "Премиум AI талдау, эксклюзивті скиндер, рейтингтік режим және т.б.",
  proFeatCoach: "Жетілдірілген AI жаттықтырушы",
  proFeatHard: "Қиын AI режимі",
  proFeatSkins: "Эксклюзивті скиндер",
  proFeatHistory: "Шексіз ойын тарихы",
  proFeatRanked: "Рейтингтік режим",
  proFeatChallenges: "Премиум тапсырмалар",
  proPrice: "$4.99/айына",
  proActivate: "Pro-ны қосу (Демо)",
  proActivated: "Pro қосылды — премиум ойынды бастаңыз!",
  proActive: "Pro белсенді",
  proPaymentNote: "Тек демо — нақты төлем жасалмайды.",
  mode: "Режим",
  classicMode: "Классикалық режим",
  wordMode: "Сөз режимі",
  wordModeTip: "Сөз режимі: 4 чипті қосып, бонустар үшін сөздер жасаңыз.",
  wordBonus: "Сөз бонусы",
  wordDetected: "Сөз табылды",
  bonusCoins: "Бонус тиындар",
  formWordsHint: "Бонустар үшін сөздер құраңыз",
